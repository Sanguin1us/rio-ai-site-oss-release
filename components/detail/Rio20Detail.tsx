...
export const Rio20Detail: React.FC<Rio20DetailProps> = ({ model, onBack }) => {
                        ...
                        <div className="relative rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg">
                            ...
                            <div className="relative flex h-full flex-col gap-6">
                                <div className="grid gap-4 lg:grid-cols-2">
                                    {METRIC_CONFIGS.filter(config => config.metric !== 'livebench').map((config) => (
                                        <div
                                            key={config.metric}
                        ...
                        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-prose-light">
                                    Como o modelo não tem um controlador de esforço de pensamento, definimos o uso de
                        ...
                        <div className="mt-10 rounded-[32px] border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-6 sm:p-8">
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-sm text-prose-light max-w-4xl">
                                    ...
                                    maneira ampla.
                                    <br />
                                    O diagrama demonstra como o Rio 2.0 simultaneamente maximiza três objetivos: RL,
                                    SFT e OPD,
                                    <br />
